...
<!-- Onda de pulso -->
<svg id="pulse-wave" viewBox="0 0 1000 290" preserveAspectRatio="none"
...
(function() {{
  ...
  const W = 1000, CY = 145;  /* CY = 145/290 = 50% del viewBox → centrado */
  let   animId = null;
  ...
  function makeWave() {{
    ...
    for (let x = 0; x <= W; x += 2) {{
      ...
      const rWave = gauss(x, MID,        16, -132); /* peak y = 145-132 = 13 */
      const sWave = gauss(x, MID + 28,   14,  35);
      const tWave = gauss(x, MID + 130,  42, -38);
